...
SPECIAL INSTRUCTIONS FOR EARTH SPELLS

Cavern Darkness - Since the Cavern Darkness spell may not be cast through doors or walls, you may need to make several copies of the Cavern Darkness tile and cut it into different configurations.  Another option may be to print off several copies of it, having them handy to cut into whatever configuration you need when the spell is cast.

Wall of Stone - You can use the blocked passage tiles that come with HeroQuest to create the Wall.
